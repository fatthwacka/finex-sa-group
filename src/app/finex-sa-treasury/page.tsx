...
import { TrendingUp, Calculator, FileCheck, Clock, Globe, Shield } from 'lucide-react';
import { BRANDS, GROUP } from '@/config/brands';

export const metadata: Metadata = {
  title: 'Finex SA Treasury | Corporate Forex & Treasury Management South Africa',
  description:
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-white mb-6">
                <span className="italic font-light">Master</span> <span className="font-extrabold">Global Cash Flow.</span>
              </h1>
              <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10">
                <span className="italic font-light">Timing is everything.</span> Every missed payment window, unhedged currency risk, or regulatory misstep can cost you opportunity. We apply a <span className="font-bold text-white">merchant bank approach</span> — designing treasury systems built exactly around your operational realities for multinational corporations and high-volume importers and exporters.
              </p>
              <CTAButton
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="max-w-2xl">
              <h2 className="text-white">
                <span className="italic font-light">Discover</span> <span className="font-extrabold">tailor-made</span><br />
            ...
            <ScrollReveal type="slide" direction="left">
              <div>
                ...
                <p className="text-white/85 text-lg leading-relaxed">
                  Finex SA offers specialised foreign currency risk management services to help
                  clients <span className="font-bold text-white">navigate currency fluctuations effectively</span>. Each quarter, our treasury
                  team collaborates with clients to assess projected currency inflows and outflows
                  for the upcoming quarter. Based on this analysis, we develop <span className="font-bold text-white">tailored currency risk
                  management strategies</span> that align with each client's unique needs.
                </p>
              </div>
            </ScrollReveal>
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, i) => {
              const { Icon } = service;
              return (
                <ScrollReveal key={service.title} type="slide" direction="up" delay={i * 2}>
                  <div
              ...
              <div>
                ...
                <div className="space-y-6 text-white/85 text-lg leading-relaxed">
                  <p>
                    ...
                    currency inflows and outflows to build <span className="font-bold text-white">bulletproof hedging strategies</span>. From
                    managing exchange control regulations to optimising multi-currency cash flows, we
                    bring a <span className="font-bold text-white">360-degree approach</span> to treasury management that aligns with your strategic
                    goals.
                  </p>
                  <p>
                    We assist in implementing the appropriate currency risk management tools,
                    including facilitating <span className="font-bold text-white">Forward Cover Contracts</span>, and Stop and Limit orders. We also
                    expertly guide clients through the completion of complex <span className="font-bold text-white">Balance of Payments</span>
                    {' '}forms.
                  </p>
                  <p>
                    Enjoy the best rates with no hidden margins or fees, processing all transactions
                    from your own account in your own name with <span className="font-bold text-white">SPOT and NEXT Day payments</span>.
                  </p>
                </div>
              </div>
            </ScrollReveal>
      ...
      <section className="section-padding section-exec">
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            <ScrollReveal type="slide" direction="up">
              <h2 className="text-exec-accent mb-6">Safe, Regulated, and Fully Licensed</h2>
              <p className="text-white/85 text-lg mb-10 max-w-3xl mx-auto">
                Finex SA (Pty) Ltd, a registered financial service provider follows a
                <span className="font-bold text-white"> merchant bank approach</span>. Our aim is to be an expert solutions-oriented company,
                dealing with multinational corporations in international trade.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <div className="px-6 py-4 rounded-xl border border-[color-mix(in_srgb,var(--color-exec-accent)_35%,transparent)] bg-white/[0.03]">
                  <div className="text-xs tracking-[0.2em] uppercase text-exec-accent mb-1">FSP License</div>
                  <div className="font-bold text-white text-lg">{GROUP.fsp}</div>
                </div>
                <div className="px-6 py-4 rounded-xl border border-[color-mix(in_srgb,var(--color-exec-accent)_35%,transparent)] bg-white/[0.03]">
                  <div className="text-xs tracking-[0.2em] uppercase text-exec-accent mb-1">SARB Intermediary</div>
                  <div className="font-bold text-white text-lg">{GROUP.sarb}</div>
                </div>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-white mb-4">
                Ready to <span className="text-exec-accent font-extrabold">optimise</span> your treasury?
              </h2>
