          ...
          <div className="max-w-4xl mx-auto mb-12">
            <ScrollReveal>
              ...
              <p className="text-lg text-white/80">
                With over 5.8 million cryptocurrency users in South Africa, the landscape of value
                exchange is shifting rapidly. Finex Pay is focused on alternative payment gateways
                and crypto integrations, providing the bridge between traditional fiat environments
                and the future of digital currency.
              </p>
            </ScrollReveal>
          </div>
          <FeatureGrid features={finexPayFeatures} columns={3} variant="on-dark" />
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <ScrollReveal>
              ...
              <p className="text-lg text-[var(--color-text-secondary)]">
                Finex Technologies develops, deploys, and maintains the sophisticated software
                architecture that powers our digital wallets, remittance platforms, and high-volume
                payroll systems. This dedicated technology division ensures absolute data security,
                real-time execution capabilities, and the agility to adapt to evolving market
                demands instantly.
              </p>
            </ScrollReveal>
          </div>
          <FeatureGrid features={finexTechFeatures} columns={3} variant="on-warm" />
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <ScrollReveal delay={0}>
              <div className="text-center text-white">
                <div className="text-4xl md:text-5xl font-extrabold mb-2">5.8M+</div>
            ...
            <ScrollReveal delay={0.3}>
              <div className="text-center text-white">
                <div className="text-4xl md:text-5xl font-extrabold mb-2">Real</div>
          ...
          <div className="text-center">
            <ScrollReveal>
              ...
              <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
                Whether you&apos;re looking to integrate our payment solutions or explore
                partnership opportunities, our technology team is ready to help.
              </p>
              <CTAButton
