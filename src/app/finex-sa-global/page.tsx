...
export const metadata: Metadata = {
  title:
    "Finex SA Global | International Expansion & Wealth Protection for Mid-Cap Companies",
  description:
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-white mb-6">
                <span className="italic font-light">Strategic Expansion</span>{" "}
                and <span className="font-extrabold">Wealth Protection.</span>
              </h1>
              <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-10">
                Finex SA Global provides{" "}
                ...
                <span className="font-bold text-white">
                  four distinct pillars of expertise
                </span>
                .
              </p>
              <CTAButton
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/75 max-w-2xl mx-auto">
                Scale without borders with our comprehensive suite of global
                services.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
              ...
              <div>
                ...
                <div className="space-y-4 text-white/85 text-lg leading-relaxed">
                  <p>
                    ...
                    <span className="font-bold text-white">expert advice</span>{" "}
                    in cash flow management and foreign exchange with{" "}
                    <span className="font-bold text-white">
                  ...
                  <p>
                    ...
                    <span className="font-bold text-white">
                      {" "}
                      unparalleled access to financial insights
                    </span>{" "}
            ...
            <ScrollReveal type="slide" direction="right">
              <div>
                ...
                <div className="space-y-4 text-white/85 text-lg leading-relaxed">
                  <p>
                    At Finex SA Global, we believe that{" "}
                    <span className="font-bold text-white">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal type="slide" direction="up" delay={3}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  <h3 className="text-2xl font-extrabold text-exec-accent mb-3">
                    Krugerrands
                  </h3>
                  <p className="text-white/80 leading-relaxed">
                    Invest in globally liquid Krugerrands, which hold legal
                    tender status, for secure wealth protection with{" "}
                    <span className="font-bold text-white">
                      guaranteed buyback
                    </span>
                    .
                ...
                >
                  ...
                  <p className="text-white/80 leading-relaxed">
                    ...
                    gold and silver bars in various weights to enable flexible
          ...
          <ScrollReveal type="slide" direction="up">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-white mb-6">
                <span className="font-light italic">Secure</span> your future
                with{" "}
              ...
              <p className="text-base text-white/70 mb-10">
                Contact us today to explore how our tailored solutions can
                enhance your business growth and secure your financial future.
              </p>
              <CTAButton
                label="Speak to Our Global Experts"
                href="/contact"
